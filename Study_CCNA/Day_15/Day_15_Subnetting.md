...
| Đối tượng | Số lượng Host | Ghi chú |
| :--- | :---: | :--- |
| TOKYO LAN A | 110 | Ưu tiên 1 |
| TORONTO LAN B | 45 | Ưu tiên 2 |
...
We need to borrow bits to support **29 hosts**.
...
TOTAL USABLE HOSTS:   30 hosts (2^5 - 2)
```
## TOKYO LAN B

We need to borrow bits to support **8 hosts**.  
Remember: **usable hosts = 2^x - 2**
...
TOTAL USABLE HOSTS:   14 hosts (2^4 - 2)
``` 
## POINT TO POINT CONNECTIONS

We need to borrow bits to support **4 hosts**.  
Remember: **usable hosts = 2^x - 2**
...
TOTAL USABLE HOSTS:   2 hosts (2^2 - 2)
```