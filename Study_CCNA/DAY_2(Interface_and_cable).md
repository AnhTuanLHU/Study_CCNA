...
- **UTP (Unshielded Twisted Pair)** → no metallic shield, twist protects against EMI.  
- Most use 8 wires (4 pairs).  
- 10/100BASE-T = 2 pairs (4 wires).  

Common Ethernet Cable Categories (Cat)
...
Each ethernet cable has an **RJ-45 plug with 8 pins** on the ends.  
...
➡️ This allows **Full-Duplex** transmission of data.  
...
- Routers TX data on Pins #1-2  
- Routers RX data on Pins #3,6  
- Switches TX data on Pins #3,6  
- Switches RX data on Pins #1-2  

➡️ Routers and PCs connect the same way with Switches.  
➡️ The cable used = **"Straight-Through" cable**.  
...
We **must** use a **Crossover cable** → this swaps pins.  
